...
from app_admin.views import organizer_dashboard, create_event, details, update_event, delete_event, delete_participant, participants_details, edit_participants_details, category_details, edit_category_details, delete_category, search_event, create_category
